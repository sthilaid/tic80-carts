...
(define (dir->num) (case (player-dir p) ((dir::left) -1.0) ((dir::right) 1.0)))
  ...
  (if (t80::btnp 4)
      (cond ((can-jump?) (let ((v (player-vel p)))
            ...
            ((can-wall-jump?) (let ((v (player-vel p)))
                                (vec-set-x! v (* (dir->num) jump-impulse 0.5))
...
(define (update-inair)
  (let ((pos (player-pos p))
    ...
    (if (and (eq? (player-state p) pstate::walljump)
             (> (vec-y vel) 0))
        (change-state pstate::inair))
    (if (> (abs (vec-x vel)) 0.001)
        (player-set-dir! p (if (> (vec-x vel) 0.001) dir::right dir::left)))
...
(define (draw)
  ...
  (t80::print (format #f "wj? ~s" (can-wall-jump?)) 0 10)
  )
...
;; 006:
;; 007:
;; 008:
;; 009:
;; 010:
;; 011:
;; 012:
;; 013:
;; 014:
;; 015:
