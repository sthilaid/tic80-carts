...
(enum dir left right)
(defstruct player pos vel dir (prev-state pstate::idle) (state pstate::idle) state-t (slope-tile #f))
...
(define (change-state new-state)
  (let ((current-state (player-state p)))
      (if (not (eq? new-state current-state))
          (begin (player-set-prev-state! p current-state)
...
;; 013:
;; 014:
